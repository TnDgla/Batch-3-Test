...
function toggleDarkMode() {
    ...
    let content = document.getElementById("mode");
    text = content.innerText;
    // Switch to dark mode
    let bg_class = document.getElementById("mode");
    console.log(bg_class)
    if (text == "Dark Mode") {
        content.textContent = "Light Mode";

        // element.style.backgroundColor = "white";
        // bg_class.style.backgroundColor = "black";
    }
    else {
        // bg_class.style.backgroundColor = "white";
        content.textContent = "Dark Mode";
